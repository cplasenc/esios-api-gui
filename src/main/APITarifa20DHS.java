...
public class APITarifa20DHS {
    ...
    private static final String MAIN_URL = "https://api.esios.ree.es/indicators/1015?start_date=#START#&end_date=#END#";
    
    public static Map<String,String> getPrecioyFecha() {
        ...
        if (data.containsKey("indicator")) {
            ...
            if (indicator.containsKey("values")) {
                ...
                if (!values.isEmpty()) {
                    ...
                    results.put("result", resultado);
                    results.put("min", BigDecimal.valueOf(minPrecio).divide(BigDecimal.valueOf(1000), 5, RoundingMode.HALF_UP).toString() + " €/kWh");
                    results.put("max", BigDecimal.valueOf(maxPrecio).divide(BigDecimal.valueOf(1000), 5, RoundingMode.HALF_UP).toString() + " €/kWh");
                    return results;
                }
            }
        }
